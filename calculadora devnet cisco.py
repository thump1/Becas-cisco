...
ventana=Tk()
ventana.title("CALCULADORA DEVNET CISCO")
...
def opera_calculo(operador):
    ...
    if operador=="+":
        ...
        resultado=sin(float(numero))
    elif operador=="cos":
        resultado=cos(float(numero))
    elif operador=="tan":
        resultado=tan(float(numero))
    elif operador=="√":
...
Entry(ventana,font=('Arial',23,'bold'),textvariable=numeroPantalla,width=21,bd=2,bg="gray13",justify="right").place(x=1,y=30)
...
Button(ventana,text="x^2",width=6,fg="white",bg="gray6",height=1,command=lambda:calculo("x^2")).place(x=4,y=100)
Button(ventana,text="√",width=7,fg="white",bg="gray13",height=2,command=lambda:calculo("√")).place(x=302,y=238)
Button(ventana,text="sin",width=6,fg="white",bg="gray6",height=1,command=lambda:calculo("sin")).place(x=65,y=100)
Button(ventana,text="cos",width=6,fg="white",bg="gray6",height=1,command=lambda:calculo("cos")).place(x=126,y=100)
Button(ventana,text="tan",width=6,fg="white",bg="gray6",height=1,command=lambda:calculo("tan")).place(x=187,y=100)
